...
@section('content')
    ...
    ">
            <h1 style="margin:0; color: #212529;">Llista de clients actius</h1>
        ...
        @if($clients->count() > 0)
            <table style="width: 100%; border-collapse: collapse; background-color: white; box-shadow: 0 2px 5px rgba(0,0,0,0.1); margin-top: 15px;">
                <thead>
